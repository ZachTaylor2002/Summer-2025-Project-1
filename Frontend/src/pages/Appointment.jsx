...
const Appointment = () => {
  ...
  //First we must get the Doctors'ID
  ...
  //Going to create the time slots for appoinments here
  ...
  //This function here will contain the logic to get the avaiable Slots
  const getAvailableSlots = async () => {

    //First we must clear the previous slots 
    setDocSlots([])
    ...
    for(let index = 0; index < 7; index++){
      ...
      while( currentDate < endTime ){
        ...
        //Removing the entries of doctor slots that has been taken up 
  ...
  const bookAppointment = async () => {
    ...
    if(!token){
      toast.warn('Login to book an appoinment')
  ...
  return docInfo && (
    <div>
      ...
      {/* Listing out the Related Doctors here */}
